...
const codeTable = ['00388', '02208', '01951', '01448', '01171', '02800', '00700', '09988'];
...
async function main() {
 await fetchAllData() // firstly fetch all basObj
 await processQueue();
 await updateInfo();
...
function showStat() {
 ...
 statMsg = statMsg + " <r>3日趋势升：" + status3UpCnt + "</r>&emsp;"
 statMsg = statMsg + " <gr>3日趋势跌：" + status3DnCnt + "</gr>&emsp;"

 statMsg = statMsg + " <r>4日趋势升：" + status4UpCnt + "</r>&emsp;"
 statMsg = statMsg + " <gr>4日趋势跌：" + status4DnCnt + "</gr>&emsp;"

 statMsg = statMsg + " <r>5日趋势升：" + status5UpCnt + "</r>&emsp;"
 statMsg = statMsg + " <gr>5日趋势跌：" + status5DnCnt + "</gr>&emsp;"

 statMsg = statMsg + " <r>10日趋势升：" + status10UpCnt + "</r>&emsp;"
 statMsg = statMsg + " <gr>10日趋势跌：" + status10DnCnt + "</gr>&emsp;"
...
function checkXStatus(shortperiod, longperiod) {
 ...
 if (curSWma > prevSWma) {
  ...
  shortTrendMsg = shortperiod + "<gr>日趋势跌</gr>&emsp;";
...
async function testmain() {
 ...
 console.log("dataObj keys BaseObj.hk00388:" + Object.keys(BaseObj.hk00388));
 // theCode, stkname, lastDateValue, closes, high, low
 console.log("<br>BaseObj.hk00388.theCode<br>" + BaseObj.hk00388.theCode)
 console.log("<br>BaseObj.hk00388.stkname<br>" + BaseObj.hk00388.stkname)
 console.log("<br>BaseObj.hk00388.lastDateValue<br>" + BaseObj.hk00388.lastDateValue)
 console.log("<br>BaseObj.hk00388.closes<br>" + BaseObj.hk00388.closes)
 console.log("<br>BaseObj.hk00388.high<br>" + BaseObj.hk00388.high)
 console.log("<br>BaseObj.hk00388.low<br>" + BaseObj.hk00388.low)
